...
myApp.config(function ($routeProvider) {
  const routes = [
    { path: "/home", templateUrl: "pages/Home.html", controller: "myCtrl" },
    { path: "/about", templateUrl: "pages/AboutUs.html", controller: "myCtrl" },
    {
      path: "/gallery",
    ...
    { path: "/faqs", templateUrl: "pages/FAQ.html", controller: "myCtrl" },
    { path: "/cart", templateUrl: "pages/cart.html", controller: "myCtrl" },
    {
      path: "/register",
      templateUrl: "Spages/ignUp.html",
      controller: "myCtrl",
    },
    { path: "/login", templateUrl: "pages/SignIn.html", controller: "myCtrl" },
    {
      path: "/products/:name",
    ...
    {
      path: "/ceiling-lights",
      templateUrl: "pages/CellingLights.html",
      controller: "ceilingListsController",
    },
    {
      path: "/wall-lights",
      templateUrl: "pages/WallLights.html",
      controller: "wallListsController",
    },
    {
      path: "/lamps",
      templateUrl: "pages/Lamps.html",
      controller: "lampListsController",
    },
    {
      path: "/outdoor-lights",
      templateUrl: "pages/OutdoorLights.html",
    ...
    {
      path: "/home-accent",
      templateUrl: "pages/HomeAccent.html",
      controller: "homeaccentListsController",
    },
    {
      path: "/spot-lights",
      templateUrl: "pages/SpotLights.html",
      controller: "spotListsController",
    },
    {
      path: "/decoration-lights",
      templateUrl: "pages/DecorationLights.html",
      controller: "decorationListsController",
    },
    {
      path: "/smart-lights",
      templateUrl: "pages/SmartLights.html",
